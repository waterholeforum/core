...
/**
 * Controller for admin reaction type management.
 */
class ReactionTypeController extends Controller
{
    ...
    public function create(ReactionSet $reactionSet)
    {
        ...
        return view('waterhole::admin.reactions.reaction-type', compact('form', 'reactionSet'));
    }
    ...
    public function edit(ReactionSet $reactionSet, ReactionType $reactionType)
    {
        ...
        return view(
            'waterhole::admin.reactions.reaction-type',
