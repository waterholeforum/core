<div class="getting-started card stack-md">
    <h2 class="h3">{{ __('waterhole::admin.getting-started-title') }}</h2>
    ...
    <div class="grid" style="--grid-min: 30ch; gap: 0">
        ...
        >
            ...
            <div class="stack-xs">
                ...
                <div class="color-muted text-xs">Learn how to build a successful
                    community with Waterhole.
                </div>
            </div>
        </a>
        ...
        >
            ...
            <div class="stack-xs">
                ...
                <div class="color-muted text-xs">
                    Configure the channels and
                    pages that make up the skeleton of your community.
                </div>
            </div>
        </a>
        ...
        >
            ...
            <div class="stack-xs">
                ...
                <div class="color-muted text-xs">Set up groups for moderators,
        ...
        >
            ...
            <div class="stack-xs">
                ...
                <div class="color-muted text-xs">Learn how to integrate
                    Waterhole with your brand and make it your own.
                </div>
            </div>
        </a>
    </div>
