<div class="card stack-md">
    ...
    <div class="grid" style="--grid-min: 30ch; gap: 0">
        <a href="#" class="cluster-md align-start block-link">
        ...
        <a href="{{ route('waterhole.admin.structure') }}" class="cluster-md align-start block-link">
        ...
        <a href="{{ route('waterhole.admin.groups.index') }}" class="cluster-md align-start block-link">
