...
<x-waterhole::cp-layout :title="$title">
    ...
    <x-waterhole::form
        ...
        action="{{ isset($channel) ? route('waterhole.cp.structure.channels.update', compact('channel')) : route('waterhole.cp.structure.channels.store', ['parent_id' => request('parent_id')]) }}"
