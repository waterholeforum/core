  ...
  _createClass(HeaderController, [{
    ...
    value: function initialize() {
      ...
      this.observer = new IntersectionObserver(function (entries) {
        _this2.breadcrumbTarget.hidden = entries[0].isIntersecting;
      }, {
        rootMargin: "-".concat(this.element.offsetHeight, "px")
      });
    }
  }, {
    key: "connect",
    value: function connect() {
      ...
      this.breadcrumbTarget.innerHTML = (h1 === null || h1 === void 0 ? void 0 : h1.innerHTML) || '';

      if (h1) {
        (_a = this.observer) === null || _a === void 0 ? void 0 : _a.disconnect();
        (_b = this.observer) === null || _b === void 0 ? void 0 : _b.observe(h1);
      }
    }
  }, {
    key: "disconnect",
...
HeaderController.targets = ['breadcrumb'];
  ...
  _createClass(d, [{
    ...
    value: function connectedCallback() {
      ...
      this.shadowRoot.firstElementChild.hidden = !0, this.menu.hidden = !0, this.button.setAttribute("aria-haspopup", "true"), this.button.setAttribute("aria-expanded", "false"), this.button.addEventListener("click", function () {
        ...
        ("menuitem" === (null == e ? void 0 : e.getAttribute("role")) || "menuitemradio" === (null == e ? void 0 : e.getAttribute("role")) || (null == e ? void 0 : e.closest("[role=menuitem], [role=menuitemradio]"))) && (_this2.open = !1);
      }), this.open = !1;
    }
  }, {
...
/* harmony import */ var _controllers_channel_picker__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./controllers/channel-picker */ "./resources/js/controllers/channel-picker.ts");
/* harmony import */ var _controllers_comment__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./controllers/comment */ "./resources/js/controllers/comment.ts");
/* harmony import */ var _controllers_comment_replies__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./controllers/comment-replies */ "./resources/js/controllers/comment-replies.ts");
...
window.Stimulus.register('channel-picker', _controllers_channel_picker__WEBPACK_IMPORTED_MODULE_4__.default);
window.Stimulus.register('modal', _controllers_modal__WEBPACK_IMPORTED_MODULE_9__.ModalController);
window.Stimulus.register('header', _controllers_header__WEBPACK_IMPORTED_MODULE_7__.HeaderController);
