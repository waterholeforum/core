...
class DefaultSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Community Guide
        $guide = Page::firstOrCreate(['slug' => Str::slug(__('waterhole::install.guide-title'))], [
            'icon' => 'emoji:📖',
        ...
        // Reactions
        $emoji = ReactionSet::firstOrNew(['name' => __('waterhole::install.reaction-set-emoji')], [
            ...
            if ($channel->wasRecentlyCreated) {
                ...
                $channel
                    ...
                    ->saveMany([
                        ...
                        (new Permission(['ability' => 'moderate']))
                            ->recipient()
                            ->associate($mod),
                    ]);
