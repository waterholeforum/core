...
group-visibility-label = Visibility
group-mentionable-label = Mentions
group-mentionable-description = Controls who can notify members by typing @group:{ $name }.
group-mentionable-moderators-label = Moderators only
group-mentionable-members-label = Moderators & group members
group-mentionable-anyone-label = Anyone
