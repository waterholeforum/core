...
taxonomies-title = 分類標籤
create-taxonomy-button = 建立 
create-taxonomy-title = 建立分類標籤
edit-taxonomy-title = 編輯分類標籤
taxonomy-details-title = 詳細資訊
taxonomy-permissions-title = 權限
taxonomy-tags-title = 標籤
taxonomy-name-label = 名稱
taxonomy-saved-message = 分類標籤已儲存。
delete-taxonomy-confirm-message = 確定要刪除此分類標籤嗎？
