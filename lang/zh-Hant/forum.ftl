...
search-sort-relevance = 按相關性排序
search-sort-latest = 按最新排序
search-sort-top = 按熱門排序
...
mark-as-answer-button = 標記為答案
unmark-as-answer-button = 取消標記答案
comment-answer-badge = 答案
...
filter-oldest = 最舊
filter-top = 熱門
filter-top-all-time = 歷史熱門
filter-top-year = 年度熱門
filter-top-quarter = 當季熱門
filter-top-month = 本月熱門
filter-top-week = 這週熱門
filter-top-day = 今日熱門
